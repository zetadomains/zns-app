...
const Privacy = () => { 
  return (
    <div className="text-content pb-5 mb-5">
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Zeta Domains.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Zeta Domains, accessible from <a href="https://zeta.domains" rel="external nofollow noopener" target="_blank"> https://zeta.domains</a></p>
        </li>
        <li>
