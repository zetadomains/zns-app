            ...
            {this.state.isAvailablePending ? 
                ...
                <div className="container mt-3"> 
                    <div className={this.state.available ? "alert alert-success text-center": "alert alert-danger text-center" }>
                        <h3>  
                            <>
                                { this.state.available ? <> <b>{obscureLabel(this.props.name, 30)}.zeta</b> is available to claim 🥳 </>: <><b>{obscureLabel(this.props.name, 30)}.zeta</b> is not available to claim 🙁</>}
                            </> 
                        </h3>
                    </div>
                </div>
