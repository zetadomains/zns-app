                                            ...
                                            <>
                                                { this.state.isCommitted || (this.state.isCommitmentExists && !this.state.isTimerCompleted) ?
                                                    <CountdownCircleTimer 
                                                            ...
                                                            strokeWidth={3}
                                                            isPlaying
                                                            duration={ this.state.countdown < 1 ? Number(process.env.REACT_APP_TIMER_COUNTDOWN): this.state.countdown } 
                        ...
                        centered>
                            <Modal.Header>
                                <Modal.Title id="contained-modal-title-vcenter">
                                    <h2>You claimed <b>{obscureName(this.props.name, 50)}.zeta</b> 😎</h2>
                                </Modal.Title>
                            </Modal.Header>
